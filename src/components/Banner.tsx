...
const Banner = () => {
  return (
    ...
    >
      ...
      <div className="relative  sm:pt-20 lg:pt-0 lg:absolute lg:bottom-12 lg:left-1/2 lg:-translate-x-1/2 w-full max-w-[90%] md:max-w-5xl 3xl:max-w-7xl 5xl:max-w-8xl z-20 mb-4 lg:mb-0">
